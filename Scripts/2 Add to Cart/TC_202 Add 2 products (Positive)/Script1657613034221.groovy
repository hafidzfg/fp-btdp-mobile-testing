...
WebUI.verifyElementText(findTestObject('CartFullPage/text_ProductName_item2'), 'Beanie')

WebUI.verifyElementAttributeValue(findTestObject('CartFullPage/input_text_qty_item2'), 'value', '1', 5)
