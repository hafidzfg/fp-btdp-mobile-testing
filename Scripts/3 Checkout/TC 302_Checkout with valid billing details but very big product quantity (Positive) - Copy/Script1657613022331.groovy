...
WebUI.setText(findTestObject('CartFullPage/input_text_qty_item1'), '9999999999')

WebUI.click(findTestObject('CartFullPage/button_Update cart'))

WebUI.verifyElementAttributeValue(findTestObject('CartFullPage/input_text_qty_item1'), 'value', '9999999999', 5)
...
WebUI.verifyElementPresent(findTestObject('Checkout/Alerts/text_alert_Maximum amount for using this payment is IDR Rp200.000.000'), 
    15)
