...
WebUI.setText(findTestObject('Login page/input_text_Username or E-mail'), GlobalVariable.invalidUsername)

WebUI.setText(findTestObject('Login page/input_text_Password'), GlobalVariable.password)

WebUI.click(findTestObject('Login page/button_Login'))

WebUI.verifyElementPresent(findTestObject('Login page/text_alert_Password is incorrect. Please try again (top of username)'), 
    5)
