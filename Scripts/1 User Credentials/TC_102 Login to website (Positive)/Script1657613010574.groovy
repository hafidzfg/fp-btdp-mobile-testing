...
CucumberKW.runFeatureFile('Include/features/WP-8 Hafidz Firmansyah G - TC Login to website.feature')
...
WebUI.click(findTestObject('Navigation Bar/span_My account'))

WebUI.verifyElementText(findTestObject('My Account/text_AccountName'), GlobalVariable.username)
