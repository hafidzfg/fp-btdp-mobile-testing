...
// get price of the 1st item as string
...
WebUI.setText(findTestObject('CartFullPage/input_text_qty_item1'), '2')

WebUI.click(findTestObject('CartFullPage/button_Update cart'))

WebUI.verifyElementAttributeValue(findTestObject('CartFullPage/input_text_qty_item1'), 'value', '2', 5)
...
WebUI.verifyEqual(subtotalItem1, price1*2)
